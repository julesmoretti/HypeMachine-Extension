...
window.onload = function () {
	...
	var main = function() {
		...
		*/
		(function(i,s,o,g,r,a,m){i['GoogleAnalyticsObject']=r;i[r]=i[r]||function(){(i[r].q=i[r].q||[]).push(arguments)},i[r].l=1*new Date();a=s.createElement(o),m=s.getElementsByTagName(o)[0];a.async=1;a.src=g;m.parentNode.insertBefore(a,m)})(window,document,'script','//www.google-analytics.com/analytics.js','_dlExtGATracker');
					...
					jQuery('ul.tools').each(function(index, track) {
						...
						if ( typeof(hasDownloadButton) === 'undefined' || !hasDownloadButton ) {
							jQuery.getJSON("/serve/source/"+ id + "/" + key, function(data) {
								...
								var download_button_jules = document.createElement("span");
								download_button_jules.title = artist + ' - ' + title + '.mp3';
								download_button_jules.id = download_url;
								download_button_jules.className = "DownloadJulesSongButton";
								download_button_jules.innerHTML = "JULES"
								...
								// jQuery(track).prepend('<li class="dl"><table class="spacer"></table>'+jQuery(download_button_jules)[0].outerHTML+""+jQuery(download_button)[0].outerHTML + '</li>');
